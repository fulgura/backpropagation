...
for indice = 1 : 5
    ...
    [W1 b1 W2 b2 iteracion AVGError] = BackPropagationProcesar(TrainingPatrones', claseTrainingTansig', FuncionCapaOculta, FuncionCapaSalida, 4, 5, Alfa, CotaError, MAX_ITER);
